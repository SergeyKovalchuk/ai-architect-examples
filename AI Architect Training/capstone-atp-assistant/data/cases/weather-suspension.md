...
between specified games or sets when temperature/humidity thresholds are exceeded. On
resumption, the match continues from the exact score and server. Decisions on whether
conditions are playable rest with the referee/supervisor, not the players.
